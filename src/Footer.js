                        ...
                        <div className="row mt-4">
                            ...
                            <div className="col-lg-4 col-md-6 mb-4 mb-md-0">
                                ...
                                <ul className="fa-ul" style={{marginLeft: "1.65em;"}}>
                                    ...
                                    <li className="mb-3">
                                        <span className="fa-li"><i className="fas fa-envelope"></i></span><span className="ms-2"><a href="mailto:info@foodmania.com" className="ms-2 text-white" style={{textDecoration:"none"}}>info@foodmania.com</a></span>
                                    </li>
                                    <li className="mb-3">
                                        <span className="fa-li"><i className="fas fa-phone"></i></span><span className="ms-2"><a href="tel:+4823456788" className="ms-2 text-white" style={{textDecoration:"none"}}>+48 234 567 88</a></span>
                                    </li>
                                </ul>
                            </div>
